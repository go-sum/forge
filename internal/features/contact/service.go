...
func NewService(q *queue.Client, cfg Config) *Service {
	return &Service{queue: q, cfg: cfg}
}

func (s *Service) Submit(ctx context.Context, input model.ContactInput) error {
