...
// From extracts a typed *Error from err if one is present anywhere in the chain.
// For domain-specific error mapping (e.g. model.ErrNotFound → NotFound),
// add that logic in the consuming application's error handler.
